export function NextjsIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M18 18.5L9 5.5H7.5v13h2v-9.5l7.5 11h2v-13h-2v9.5z" fill="var(--background)"/>
      <path d="M16.5 5.5h2v13h-2z" fill="var(--background)"/>
    </svg>
  );
}
...
export function NestjsIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 3L3 7.5v9L12 21l9-4.5v-9L12 3z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
      <path d="M12 21V3" stroke="currentColor" strokeWidth="1.5" fill="none"/>
      <path d="M3 7.5l9 4.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
      <path d="M21 7.5l-9 4.5" stroke="currentColor" strokeWidth="1.5" fill="none"/>
    </svg>
  );
}

export function NodejsIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 448 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function PostgresqlIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 3c-2 0-3 .5-3 2v14c0 1.5 1 2 3 2s3-.5 3-2V5c0-1.5-1-2-3-2z" stroke="currentColor" strokeWidth="1.5" fill="none"/>
...
export function PrismaIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      <path d="M21.8 17.6L13 2.6c-.4-.7-1.5-.7-1.9 0L2.2 17.6c-.4.7 0 1.5.7 1.6l9.2 2.3c.3.1.6.1.9 0l9.2-2.3c.6-.1 1-.9.6-1.6z" stroke="currentColor" strokeWidth="0.5" fill="none"/>
      <path d="M13 3L12 20" stroke="var(--background)" strokeWidth="1.5"/>
    </svg>
  );
}
...
export function TailwindIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 3c-3 0-4.5 1.5-5 3s.5 3 2 4c-1.5.5-2.5 1.5-3 3s.5 3 2 4c-1 .5-1.5 1.5-1.5 2.5s.5 2 1.5 2.5c1 .5 2-.5 3-2s.5-4-1-5c1.5-.5 2.5-1.5 3-3s-.5-3-2-4c1.5-.5 2.5-1.5 3-3S15 3 12 3z" stroke="currentColor" strokeWidth="1.2" fill="none"/>
    </svg>
  );
}
...
export function DockerIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 640 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export function AIIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 2L2 7l10 5 10-5L12 2z" fill="currentColor" opacity="0.3"/>
...
export function ApiIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M5 12H2M22 12h-3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
      <circle cx="12" cy="12" r="2" stroke="currentColor" strokeWidth="1.5" fill="none"/>
      <path d="M8 5l4 7-4 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
      <path d="M16 5l-4 7 4 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
    </svg>
  );
}
